...
os.system("aocd 2024 7 > ./2024/day_7/input.txt")
os.system("aocd 2024 7 -e > ./2024/day_7/exampleAnswers.txt")

input = open("./2024/day_7/input.txt")
example = open("./2024/day_7/example.txt")

workingData = input.readlines()  # uncomment to try input
# workingData = example.readlines()  # uncomment to try example ANSWER:3749
